...
export default $profileDialog = function(props) {
  ...
  var {isVisibleStream, loadingItemsStream, meStream, userStream, entityAndMeStream,
    entityAndUserStream, expandedItemsStream} = useMemo(function() {
  ...
  var {me, $links, meEntityUser, user, entityUser, isVisible, entity,
  ...
  const unsetLoadingByText = function(text) {
  ...
  var renderItem = function(options) {
