...
`
), z('h5', 'Gathering of Personally-Identifying Information'), z('p',
  `\
...
`
), z('h5', 'Aggregated Statistics'), z('p',
  `\
...
), z('h5', 'Protection of Certain Personally-Identifying Information'), z('p',
...
`
), z('h5', 'Privacy Policy Changes'), z('p',
  `\
